...
var transformations = {
    ...
    'return': function(statement, statements) {
        ...
        if (is_streamlined_function_call(statement.value)) {
            ...
            statement.value.children[1].children.push(snippets.callback())
            return [statement]
        }
...
function transform_streamlined_function_call_in_expression(expression, statement, statements) {
    ...
    var found = find_streamlined_function_call(expression.children)

    var function_call_name = found.n.children[0].value
    var function_call_parameters = found.n.children[1].children

    found.n.type = IDENTIFIER
    found.n.value = ident.value
    delete found.n.children
    ...
    return [{
        ...
        children: [
            {
                type: IDENTIFIER,
                value: strip_underscore(function_call_name)
            },
            {
                type: LIST,
                children: function_call_parameters.concat([
